import{t as e}from"./preload-helper-Czpn1I53.js";var{sankey:t,sankeyLinkHorizontal:n}=await e(async()=>{let{sankey:e,sankeyLinkHorizontal:t}=await import(`/assets/d3-sankey.js`);return{sankey:e,sankeyLinkHorizontal:t}},[]),r=document.querySelector(`#stats`),i=document.querySelector(`#status-list`),a=document.querySelector(`#search-toggle`),o=document.querySelector(`#search-dialog`),s=document.querySelector(`#search-backdrop`),c=document.querySelector(`#search-form`),l=document.querySelector(`#search-input`),u=document.querySelector(`#close-search`),d=document.querySelector(`#materials-panel`),ee=document.querySelector(`#materials-toggle`),te=document.querySelector(`#materials-body`),f=document.querySelector(`#materials-summary`),ne=document.querySelector(`#materials-required-warning`),p=document.querySelector(`#resume-meta`),m=document.querySelector(`#resume-upload`),h=document.querySelector(`#resume-upload-button`),re=document.querySelector(`#resume-resource-meta`),ie=document.querySelector(`#resume-resource-upload`),ae=document.querySelector(`#resume-resource-upload-button`),oe=document.querySelector(`#resume-resource-list`),se=document.querySelector(`#cover-letter-meta`),ce=document.querySelector(`#cover-letter-upload`),le=document.querySelector(`#cover-letter-upload-button`),ue=document.querySelector(`#cover-letter-list`),de=document.querySelector(`#experience-note-meta`),fe=document.querySelector(`#experience-note-upload`),pe=document.querySelector(`#experience-note-upload-button`),me=document.querySelector(`#experience-note-list`);document.querySelector(`#material-index-button`);var he=document.querySelector(`#material-index-warning`),ge=document.querySelector(`#material-index-status`),_e=document.querySelector(`#review-discovered`),ve=document.querySelector(`#prep-interested`),g=document.querySelector(`#review-view`),ye=document.querySelector(`#review-heading`),be=document.querySelector(`#review-progress`),xe=document.querySelector(`#review-card`),Se=document.querySelector(`#close-review`),_=document.querySelector(`#prep-view`),Ce=document.querySelector(`#prep-heading`),we=document.querySelector(`#prep-progress`),v=document.querySelector(`#prep-card`),Te=document.querySelector(`#close-prep`),Ee=document.querySelector(`#prepped-roles`),De=document.querySelector(`#prepped-view`),Oe=document.querySelector(`#close-prepped`),ke=document.querySelector(`#prepped-summary`),Ae=document.querySelector(`#regenerate-all-cover-letters`),je=document.querySelector(`#prepped-bulk-status`),Me=document.querySelector(`#prepped-list`),Ne=document.querySelector(`#prepped-detail`),y=document.querySelector(`#scan-all-button`),Pe=document.querySelector(`#manage-companies-button`),b=document.querySelector(`#scan-status-bar`),Fe=document.querySelector(`#scan-status-text`),Ie=document.querySelector(`#scan-last-time`),Le=document.querySelector(`#scan-failures-open`),Re=document.querySelector(`#scan-failures-dialog`),ze=document.querySelector(`#scan-failures-backdrop`),Be=document.querySelector(`#scan-failures-close`),Ve=document.querySelector(`#scan-failures-list`),He=document.querySelector(`#toggle-all`),Ue=document.querySelector(`#collapse-empty`),We=document.querySelector(`#toolbar-summary`),Ge=document.querySelector(`#settings-open`),Ke=document.querySelector(`#settings-view`),qe=document.querySelector(`#settings-close`),x=document.querySelector(`#settings-status`),Je=document.querySelector(`#settings-form`),Ye=document.querySelector(`#settings-profile-options`),Xe=document.querySelector(`#settings-autoprep-options`),Ze=document.querySelector(`#settings-options`),Qe=document.querySelector(`#central-store-summary`),$e=document.querySelector(`#central-store-sync-summary`),et=document.querySelector(`#central-api-url-input`),tt=document.querySelector(`#central-passkey-input`),nt=document.querySelector(`#central-save-button`),rt=document.querySelector(`#central-sync-button`),it=document.querySelector(`#recommendation-history-summary`),at=document.querySelector(`#clear-recommendation-history`),ot=document.querySelector(`#metrics-open-button`),st=document.querySelector(`#metrics-view`),ct=document.querySelector(`#metrics-close`),lt=document.querySelector(`#metrics-status`),ut=document.querySelector(`#metrics-overview`),dt=document.querySelector(`#metrics-sections`),ft=document.querySelector(`#metrics-scan-list`),pt=document.querySelector(`#sankey-open-button`),mt=document.querySelector(`#sankey-view`),ht=document.querySelector(`#sankey-close`),gt=document.querySelector(`#sankey-status`),_t=document.querySelector(`#sankey-canvas`),vt=document.querySelector(`#sankey-path-list`),yt=document.querySelector(`#app-update-button`),bt=document.querySelector(`#companies-view`),xt=document.querySelector(`#companies-close`),S=document.querySelector(`#companies-status`),St=document.querySelector(`#company-create-form`),C=document.querySelector(`#companies-list`),Ct=document.querySelector(`#role-add-form`),wt=document.querySelector(`#role-url-input`),Tt=document.querySelector(`#role-company-input`),Et=document.querySelector(`#role-company-options`),Dt=document.querySelector(`#role-add-status`),Ot=3,kt=1200,At=new Set([`applied`,`OA`,`interview`,`rejected`,`offer`]),jt=new Map([[`discovered`,`#4f6472`],[`interested`,`#00897b`],[`disinterested`,`#626970`],[`applied`,`#2257ad`],[`oa`,`#b36b00`],[`interview`,`#5f2bd8`],[`rejected`,`#b93d2d`],[`offer`,`#137347`],[`closed`,`#53606b`],[`archived`,`#765b4a`]]),Mt=/^(?:about (?:the )?(?:role|team|job)|about this role|job description|job responsibilities|minimum qualifications|preferred qualifications|qualifications|requirements|responsibilities|what to expect|what (?:you'll|you’ll|you will) (?:bring|do)|what'?s in it for you|who you are|your objectives|your skills & talents):?$/i,Nt=!0,w=null,Pt=null,T=[],E=[],D=[],Ft=null,O=[],k=[],A=new Map,It=new Map,j=new Map,Lt=new Map,M=new Map,Rt=new Map,zt=new Map,Bt=new Map,N=[],P=null,Vt=null,Ht=!1,F=``,I=null,Ut=new Set,Wt=new Map,L=new Set,R=new Map,Gt=new Map,Kt=new Map,qt=new Set,Jt=!1,Yt=0,Xt=null,Zt=!1,Qt=null,$t=null,en=null,tn=null,z=null,nn=[],rn=new Map;function B(){return w?.query?.trim()??``}function an(){let e=!!B();a.classList.toggle(`search-active`,e),a.setAttribute(`aria-label`,e?`clear search`:`search jobs`)}function on(){l.value=B(),o.hidden=!1,c.hidden=!1,l.focus(),l.select()}function sn(){o.hidden=!0,c.hidden=!0,a.focus()}function cn(e){return e?new Intl.DateTimeFormat(void 0,{month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`}).format(new Date(e)).toLocaleLowerCase():``}function V(e){return e?new Intl.DateTimeFormat(void 0,{month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`}).format(new Date(e)).replace(`, `,` `).toLocaleLowerCase():``}function H(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#039;`)}function U(e){return String(e??``).toLocaleLowerCase()}function W(e){return H(U(e))}function ln(e){try{let t=new URL(String(e||``));return[`http:`,`https:`].includes(t.protocol)?t.href:``}catch{return``}}function un(e){return e}function G(e=v){e.querySelectorAll(`[data-prep-resume-latex], [data-prep-cover-letter-latex]`).forEach(un)}function dn(){return`
  ...
  `}function mn(e,t,n){let r=`<span class="role-title-text">${W(e)}</span>`;return t?`<a class="${n}" href="${H(t)}" target="_blank" rel="noreferrer">${r}${dn()}</a>`:`<span class="${n}">${r}</span>`}function hn(e){r.innerHTML=[[`companies`,e.companies_total],[`jobs`,e.jobs_total],[`applications`,e.applications_total]].map(([e,t])=>`<dl class="stat"><dt>${W(e)}</dt><dd>${t}</dd></dl>`).join(``)}function gn(e=w){if(!e){We.innerHTML=``;return}let t=t=>e.statuses.find(e=>e.key===t)?.count??0;We.innerHTML=[[`discovered`,t(`discovered`)],[`interested`,t(`interested`)],[`applied`,e.stats?.applications_total??0],[`total`,e.stats?.jobs_total??0]].map(([e,t])=>`
        <dl>
          <dt>${W(e)}</dt>
          <dd>${t}</dd>
        </dl>
      `).join(``)}function _n(e,t=``){if(Pt=e,h.textContent=e?`replace`:`upload`,t){p.textContent=t;return}if(!e){p.textContent=`no resume uploaded`;return}let n=V(e.updated_at),r=En(e.content_bytes);p.textContent=[U(e.filename),r,n].filter(Boolean).join(` | `)}function vn(e,t,n,{binary:r=!1}={}){let i=r?e.filename:e.id;return`
    ...
    </li>`}function yn(e,t=``){E=Array.isArray(e)?e:[],le.textContent=E.length>0?`add`:`upload`,se.textContent=t||(E.length===0?`no examples uploaded`:`${E.length} ${E.length===1?`example`:`examples`} stored`),ue.innerHTML=E.map(e=>vn(e,`cover-letter-examples`,En(e.content_bytes))).join(``)}function bn(e,t=``){D=Array.isArray(e)?e:[],pe.textContent=D.length>0?`add`:`upload`,de.textContent=t||(D.length===0?`no notes uploaded`:`${D.length} ${D.length===1?`note`:`notes`} stored`),me.innerHTML=D.map(e=>vn(e,`experience-notes`,En(e.content_bytes))).join(``)}function xn(e,t=``){Ft=e??null;let n=Ft?.status??`missing`,r=n!==`ready`;if(D.length,he.hidden=!r,he.textContent=t||Ft?.warning||``,t)ge.textContent=t;else if(n===`ready`){let e=Number(Ft?.document_count??0),t=Number(Ft?.skipped_source_count??0),n=V(Ft?.generated_at);ge.innerHTML=[`${e} indexed ${e===1?`page`:`pages`}`,t?`${t} unreadable upload skipped`:``,n].filter(Boolean).map(e=>`<button type="button" class="material-index-link" data-open-material-index title="Reveal the application material index in Finder">${W(e)}</button>`).join(`<span aria-hidden="true"> | </span>`)}else ge.textContent=n===`stale`?`index out of date`:`not indexed`}function Sn(e,t=``){T=Array.isArray(e)?e:[],ae.textContent=T.length>0?`add`:`upload`,re.textContent=t||(T.length===0?`no resources uploaded`:`${T.length} ${T.length===1?`resource`:`resources`} stored`),oe.innerHTML=T.map(e=>vn(e,`resume-resources`,En(e.bytes),{binary:!0})).join(``)}function Cn(e,t={}){Yt+=1,document.querySelectorAll(`[data-preview-blob-url]`).forEach(e=>{URL.revokeObjectURL(e.dataset.previewBlobUrl)}),_n(e?.master_resume??null),Sn(e?.resume_resources??[]),yn(e?.cover_letter_examples??[]),bn(e?.experience_notes??[]),xn(e?.material_index??null),wn(e?.ui),(!Jt||t.applyDefaultCollapsed)&&(Tn(!!e?.ui?.default_collapsed),Jt=!0)}function wn(e=null){let t=Pt?`resume ready`:`no resume`,n=T.length===0?`no resources`:`${T.length} ${T.length===1?`resource`:`resources`}`,r=E.length,i=r===0?`no cover letters`:`${r} cover ${r===1?`letter`:`letters`}`,a=D.length,o=a===0?`no notes`:`${a} experience ${a===1?`note`:`notes`}`;ne.hidden=!(typeof e?.has_missing_required_materials==`boolean`?e.has_missing_required_materials:!Pt||r===0||a===0),f.textContent=`${t} | ${n} | ${i} | ${o}`}function Tn(e){d.classList.toggle(`collapsed`,e),ee.setAttribute(`aria-expanded`,String(!e)),ee.querySelector(`.materials-chevron`).textContent=e?`>`:`v`,te.hidden=e}function En(e){return Number.isFinite(e)?e<1024?`${e} b`:`${Math.round(e/1024)} kb`:``}async function Dn(e){let t=await fetch(e,{cache:`no-store`});if(!t.ok)throw Error(`Preview unavailable`);let n=await t.arrayBuffer();if(new TextDecoder(`ascii`).decode(n.slice(0,5))!==`%PDF-`)throw Error(`The selected file is not a readable PDF.`);return URL.createObjectURL(new Blob([n],{type:`application/pdf`}))}async function On(e){let t=e.closest(`.material-source-item`)?.querySelector(`[data-material-preview-body]`);if(!t)return;if(t.dataset.loaded===`true`){t.hidden=!t.hidden,e.textContent=t.hidden?`preview`:`hide`;return}e.disabled=!0,e.textContent=`loading...`;let n=e.dataset.materialView,r=e.dataset.materialId,i=Yt,a=`/api/${encodeURIComponent(n)}/${encodeURIComponent(r)}`;try{if(e.dataset.materialBinary===`true`){let e=await Dn(a);if(!t.isConnected||Yt!==i){URL.revokeObjectURL(e);return}t.dataset.previewBlobUrl=e,t.innerHTML=`<iframe title="${W(r)} preview"></iframe>`,t.querySelector(`iframe`).src=e}else{let e=await fetch(a);if(!e.ok)throw Error(`Preview unavailable`);let n=await e.json(),r=document.createElement(`pre`);r.textContent=n.content||`This source is empty.`,t.replaceChildren(r)}t.dataset.loaded=`true`,t.hidden=!1,e.textContent=`hide`}catch(n){t.textContent=n instanceof Error?n.message:`Preview unavailable`,t.hidden=!1,e.textContent=`preview`}finally{e.disabled=!1}}async function kn(e){let t=e.dataset.materialRemove,n=e.dataset.materialId;if(e.dataset.confirmRemove!==`true`){e.dataset.confirmRemove=`true`,e.textContent=`confirm remove`,e.classList.add(`danger`),window.setTimeout(()=>{!e.isConnected||e.disabled||(delete e.dataset.confirmRemove,e.textContent=`remove`,e.classList.remove(`danger`))},6e3);return}e.disabled=!0,e.textContent=`removing...`;try{let e=await fetch(`/api/${encodeURIComponent(t)}/${encodeURIComponent(n)}`,{method:`DELETE`}),r=await e.json();if(!e.ok)throw Error(r.error||`Remove failed`);Cn(r)}catch(t){e.disabled=!1,delete e.dataset.confirmRemove,e.classList.remove(`danger`),e.textContent=`remove`,window.alert(t instanceof Error?t.message:`Remove failed`)}}function An(e){i.innerHTML=e.map(e=>{let t=e.jobs.map(t=>jn(t,e.key)).join(``);return`
        <section class="status-pane ${e.count===0?`empty`:``} ${Nt?`hidden-empty`:``}" id="status-${H(e.key)}" data-bucket="${H(e.key)}">
  ...
  `}function Hn(e){w=e,l.value=e.query,an(),hn(e.stats),gn(e),An(e.statuses),Ma(),fi(e.statuses),mi(e.statuses)}function Un(e){Qt=e??null;let t=!!e?.scanning,n=t&&!!e?.cancel_requested,r=Number(e?.completed_companies??0),i=Number(e?.total_companies??0),a=Number(e?.failed_companies??0),o=typeof e?.error==`string`?e.error.trim():``,s=Array.isArray(e?.failures)?e.failures:[];y.disabled=n,y.textContent=t?n?`cancelling...`:`cancel scan`:`scan roles`,y.classList.toggle(`danger`,t&&!n),b.hidden=!t&&!o&&s.length===0,b.classList.toggle(`scanning`,t),b.classList.toggle(`scan-error`,!t&&!!o||s.length>0),Fe.textContent=n?`cancelling scan...`:t?`scanning roles${i>0?` ${r}/${i}`:``}${a>0?`, ${a} failed`:``}`:s.length>0?`${s.length} recent scan ${s.length===1?`failure`:`failures`}`:o?`last scan error: ${o}`:`scan idle`,Le&&Ve&&(Le.hidden=s.length===0,Ve.innerHTML=s.slice(0,5).map(e=>{let t=e?.company_name||`unknown company`,n=e?.error||`scan failed`;return`
          <p>
            <span>${W(t)}</span>
            <span>${H(n)}</span>
          </p>
        `}).join(``),s.length===0&&Gn());let c=e?.last_scan_at;Ie.textContent=c?`last scan: ${V(c)}`:`last scan: never`,Zt&&!t&&J(B()).catch(()=>{}),Zt=t}function Wn(){Le.hidden||(Re.hidden=!1,Be.focus())}function Gn(){Re.hidden=!0}function K(e,t=``){$t=e;let n=Array.isArray(e?.settings)?e.settings:[],r=n.filter(e=>e.key?.startsWith(`applicant_`)),i=n.filter(e=>e.key?.startsWith(`autoprep_`)),a=n.filter(e=>!e.key?.startsWith(`applicant_`)&&!e.key?.startsWith(`autoprep_`)),o=e?.central??{};x.textContent=t,x.classList.toggle(`is-empty`,!t);let s=Number(e?.recommendation_history_count??0);it.textContent=s>0?`${s} saved ${s===1?`feedback decision`:`feedback decisions`}`:`no saved resume feedback decisions`,at.disabled=s===0,Kn(o),Ye.innerHTML=r.map(e=>qn(e)).join(``),Xe.innerHTML=i.map(e=>qn(e)).join(``),Ze.innerHTML=a.map(e=>qn(e)).join(``),q(!1)}function Kn(e){let t=e?.api_url??``;et.value=t,tt.value=``;let n=e?.passkey_configured?`passkey saved`:`no passkey saved`;Qe.textContent=t?`${U(t)} | ${n}`:`no api url | ${n}`,$e.textContent=`${Number(e?.companies_linked??0)} linked | ${Number(e?.companies_unlinked??0)} unlinked | ${Number(e?.companies_needs_review??0)} review | ${Number(e?.companies_failed??0)} failed`,rt.disabled=!t}function qn(e){if(e.control===`textarea`&&e.editable!==!1)return Yn(e);if(e.control===`text`&&e.editable!==!1)return Jn(e);if(e.control===`select`&&e.editable!==!1)return Xn(e);if(e.control!==`toggle`||e.editable===!1)return Zn(e);let t=e.value?`checked`:``,n=e.default?`on by default`:`off by default`;return`
  ...
  `}function q(e){Je.querySelectorAll(`input, select, textarea`).forEach(t=>{t.disabled=e}),nt.disabled=e,rt.disabled=e||!et.value.trim(),yt.disabled=e}async function Qn(){Ke.hidden=!1,document.body.classList.add(`settings-open`),qe.focus(),$t?K($t):(x.textContent=`loading settings...`,x.classList.remove(`is-empty`),Ze.innerHTML=``);try{await er()}catch{x.textContent=`could not load settings.`}}function $n(){Ke.hidden=!0,document.body.classList.remove(`settings-open`),Ge.focus()}async function er(){let e=await fetch(`/api/config`);if(!e.ok)throw Error(`Config request failed`);K(await e.json())}function tr(e){let t=e?.value;return t==null?`n/a`:e?.kind===`ratio`?Number(t).toLocaleString(void 0,{maximumFractionDigits:2,minimumFractionDigits:0}):typeof t==`number`?t.toLocaleString():U(t)}function nr(e,t=`metric-card`){return`
    <article class="${t}">
      <span>${W(e?.label)}</span>
      <strong>${H(tr(e))}</strong>
    </article>
  `}function rr(e,t=``){en=e,lt.textContent=t||(e?.updated_at?`updated ${V(e.updated_at)}`:``),lt.classList.toggle(`is-empty`,!lt.textContent);let n=Array.isArray(e?.overview)?e.overview:[],r=Array.isArray(e?.sections)?e.sections:[],i=Array.isArray(e?.recent_scans)?e.recent_scans:[];ut.innerHTML=n.map(e=>nr(e)).join(``),dt.innerHTML=r.map(ir).join(``),ft.innerHTML=i.length?i.map(ar).join(``):`<p class="empty-copy">no scan runs recorded.</p>`}function ir(e){let t=Array.isArray(e?.metrics)?e.metrics:[];return`
  ...
  `}async function or(){st.hidden=!1,document.body.classList.add(`metrics-open`),ct.focus(),en?rr(en):(lt.textContent=`loading metrics...`,lt.classList.remove(`is-empty`),ut.innerHTML=``,dt.innerHTML=``,ft.innerHTML=``);try{await cr()}catch{lt.textContent=`could not load metrics.`}}function sr(){st.hidden=!0,document.body.classList.remove(`metrics-open`),ot.focus()}async function cr(){let e=await fetch(`/api/metrics`);if(!e.ok)throw Error(`Metrics request failed`);rr(await e.json())}function lr(e,t=``){tn=e;let n=Number(e?.role_count??0),r=Array.isArray(e?.links)?e.links:[],i=Array.isArray(e?.paths)?e.paths:[];gt.textContent=t||(e?.updated_at?`${n.toLocaleString()} roles | updated ${V(e.updated_at)}`:``),gt.classList.toggle(`is-empty`,!gt.textContent),_t.innerHTML=r.length?ur(e):`<p class="empty-copy">no role transitions recorded yet.</p>`,vt.innerHTML=i.length?i.map(mr).join(``):`<p class="empty-copy">no role paths recorded yet.</p>`}function ur(e){let t=Array.isArray(e?.nodes)?e.nodes:[],n=Array.isArray(e?.links)?e.links:[],r=pr(t,n),i=r.nodes,a=r.links,o=(r.flowLinks??n).map(e=>{let t=i.get(e.source),n=i.get(e.target),r=a.get(e);if(!t||!n||!r)return``;let o=r.width,s=n.x<t.x,c=dr(e.target),l=r.priority?`0.42`:s?`0.28`:`0.34`,u=r.path??fr({isBacktrack:s,sourceX:t.x+t.width,sourceY:r.sourceY,targetX:n.x,targetY:r.targetY,width:o});return`
  ...
  `}async function jr(){bt.hidden=!1,document.body.classList.add(`companies-open`),xt.focus(),z?Tr(z):(S.textContent=`loading companies...`,S.classList.remove(`is-empty`),C.innerHTML=``);try{await Nr()}catch{S.textContent=`could not load companies.`}}function Mr(){bt.hidden=!0,document.body.classList.remove(`companies-open`),Pe.focus()}async function Nr(e=``){let t=await fetch(`/api/companies`);if(!t.ok)throw Error(`Companies request failed`);Tr(await t.json(),e)}async function Pr(){let e=await fetch(`/api/companies`);if(!e.ok)throw Error(`Companies request failed`);Er((await e.json()).companies)}async function Fr(e){let t=new FormData(e),n={name:String(t.get(`name`)??``),career_url:String(t.get(`career_url`)??``),notes:String(t.get(`notes`)??``)};S.textContent=`adding company...`;let r=await fetch(`/api/companies`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(n)});if(!r.ok)throw Error(`Company create failed`);e.reset(),Tr(await r.json(),`company added.`),J(B()).catch(()=>{})}async function Ir(e){let t=e.dataset.companyLinkForm;if(!t)return;let n=new FormData(e),r={label:String(n.get(`label`)??``),url:String(n.get(`url`)??``)};S.textContent=`adding link...`;let i=await fetch(`/api/companies/${encodeURIComponent(t)}/career-pages`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(r)});if(!i.ok)throw Error(`Career page create failed`);e.reset(),Tr(await i.json(),`link added.`)}async function Lr(e){S.textContent=`deleting link...`;let t=await fetch(`/api/company-career-pages/${encodeURIComponent(e)}`,{method:`DELETE`});if(!t.ok)throw Error(`Career page delete failed`);Tr(await t.json(),`link deleted.`)}async function Rr(e){S.textContent=`deactivating company...`;let t=await fetch(`/api/companies/${encodeURIComponent(e)}`,{method:`DELETE`});if(!t.ok)throw Error(`Company deactivate failed`);Tr(await t.json(),`company deactivated.`),J(B()).catch(()=>{})}function zr(){let e=Tt.value.trim().toLocaleLowerCase();return nn.find(t=>t.name.toLocaleLowerCase()===e)}async function Br(e){let t=zr();if(!t?.id){Dt.textContent=`pick a saved company.`;return}let n=new FormData(e),r={company_id:t.id,role_url:String(n.get(`role_url`)??``)};Dt.textContent=`adding role...`;let i=await fetch(`/api/roles`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(r)});if(!i.ok)throw Error(`Role create failed`);let a=await i.json();a.tracker?Hn(a.tracker):await J(B()),wt.value=``;let o=a.role?.title?U(a.role.title):`role`;Dt.textContent=a.scan_error?`${o} added; scan could not finish.`:`${o} added.`}function Vr(e){return(Array.isArray(z?.companies)?z.companies:[]).find(t=>String(t.id)===String(e))}function Hr(e){S.textContent=e,S.classList.remove(`is-empty`)}function Ur(e){window.clearTimeout(rn.get(e)),rn.set(e,window.setTimeout(()=>{Wr(e).catch(()=>{Hr(`could not save company.`)})},700))}async function Wr(e){let t=C.querySelector(`[data-company-id="${CSS.escape(String(e))}"]`);if(!t)return;let n=t.querySelector(`[data-company-notes="${CSS.escape(String(e))}"]`),r=t.querySelector(`[data-company-tier="${CSS.escape(String(e))}"]`),i=Vr(e),a={notes:n?.value??i?.notes??``,prestige_tier:r?.value??i?.prestige_tier??``};i&&(i.notes=a.notes,i.prestige_tier=a.prestige_tier),Gr(t,a.prestige_tier),Hr(`saving company...`);let o=await fetch(`/api/companies/${encodeURIComponent(e)}`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(a)});if(!o.ok)throw Error(`Company update failed`);z=await o.json(),Hr(`company saved.`),Kr(e)}function Gr(e,t){e.classList.remove(`company-tier-unset`,`company-tier-0`,`company-tier-1`,`company-tier-2`,`company-tier-3`,`company-tier-4`),e.classList.add(Or(t))}function Kr(e){let t=C.querySelector(`[data-company-id="${CSS.escape(String(e))}"]`),n=Vr(e);if(!t||!n)return;let r=Array.isArray(n.career_pages)?n.career_pages:[],i=V(n.updated_at),a=t.querySelector(`.company-summary-meta`);a&&(a.textContent=`${r.length} ${r.length===1?`link`:`links`}${i?` | updated ${i}`:``}`)}async function qr(){let e=await fetch(`/api/scan/status`);if(e.status===404){y.disabled=!0,b.hidden=!0,b.classList.add(`scan-error`),Fe.textContent=`restart server to enable scanning`;return}if(!e.ok)throw Error(`Scan status request failed`);Un(await e.json())}function Jr(){Xt===null&&(Xt=window.setInterval(()=>{qr().catch(()=>{})},3e3))}async function Yr(){y.disabled=!0,y.textContent=`starting...`;try{let e=await fetch(`/api/scan/all`,{method:`POST`});if(e.status===404){y.disabled=!0,y.textContent=`scan roles`,b.hidden=!0,b.classList.add(`scan-error`),Fe.textContent=`restart server to enable scanning`;return}if(!e.ok&&e.status!==409)throw Error(`Scan start failed`);Un(await e.json()),Jr()}catch{y.disabled=!1,y.textContent=`scan roles`,b.hidden=!0,b.classList.add(`scan-error`),Fe.textContent=`could not start scan`}}async function Xr(){y.disabled=!0,y.textContent=`cancelling...`;try{let e=await fetch(`/api/scan/cancel`,{method:`POST`});if(e.status===404){y.disabled=!0,y.textContent=`scan roles`,b.hidden=!0,b.classList.add(`scan-error`),Fe.textContent=`restart server to enable scanning`;return}if(!e.ok&&e.status!==409)throw Error(`Scan cancel failed`);Un(await e.json()),Jr()}catch{y.disabled=!1,y.textContent=`cancel scan`,b.hidden=!1,b.classList.add(`scan-error`),Fe.textContent=`could not cancel scan`}}async function J(e=``){i.innerHTML=`<p class="empty-copy">loading jobs...</p>`;let t=new URLSearchParams;e&&t.set(`q`,e);let n=await fetch(`/api/tracker?${t.toString()}`);if(!n.ok)throw Error(`Tracker request failed`);Hn(await n.json())}async function Zr(e={}){let t=await fetch(`/api/application-materials`);if(!t.ok)throw Error(`Application materials request failed`);Cn(await t.json(),e)}async function Qr(e){if(e){if(!e.name.toLowerCase().endsWith(`.tex`)){_n(Pt,`resume must be a .tex file.`);return}h.disabled=!0,_n(Pt,`uploading...`);try{let t=await e.text();if(!(await fetch(`/api/master-resume`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({filename:e.name,content:t})})).ok)throw Error(`Master resume upload failed`);await Zr()}catch{_n(Pt,`could not save resume.`),wn()}finally{m.value=``,h.disabled=!1}}}async function $r(e){let t=Array.from(e??[]);if(t.length!==0){ae.disabled=!0,Sn(T,`uploading ${t.length} ${t.length===1?`resource`:`resources`}...`);try{for(let e of t)if(!(await fetch(`/api/resume-resources`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({filename:e.name,content_base64:await ni(e)})})).ok)throw Error(`Resume resource upload failed`);await Zr()}catch{Sn(T,`could not save every resource.`),wn()}finally{ie.value=``,ae.disabled=!1}}}async function ei(e){let t=Array.from(e??[]);if(t.length!==0){le.disabled=!0,yn(E,`uploading ${t.length} ${t.length===1?`example`:`examples`}...`);try{for(let e of t){let t={filename:e.name};if([`.pdf`,`.docx`].some(t=>e.name.toLowerCase().endsWith(t))?t.content_base64=await ni(e):t.content=await e.text(),!(await fetch(`/api/cover-letter-examples`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)})).ok)throw Error(`Cover letter example upload failed`)}await Zr()}catch{yn(E,`could not save every example.`),wn()}finally{ce.value=``,le.disabled=!1}}}async function ti(e){let t=Array.from(e??[]);if(t.length!==0){pe.disabled=!0,bn(D,`uploading ${t.length} ${t.length===1?`note`:`notes`}...`);try{for(let e of t){let t=e.name.toLowerCase(),n={filename:e.name};if(t.endsWith(`.pdf`)||t.endsWith(`.docx`)?n.content_base64=await ni(e):n.content=await e.text(),!(await fetch(`/api/experience-notes`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(n)})).ok)throw Error(`Experience note upload failed`)}A.clear(),await Zr()}catch{bn(D,`could not save every note.`),wn()}finally{fe.value=``,pe.disabled=!1}}}function ni(e){return new Promise((t,n)=>{let r=new FileReader;r.addEventListener(`load`,()=>{let e=String(r.result??``);t(e.includes(`,`)?e.split(`,`,2)[1]:e)}),r.addEventListener(`error`,()=>n(r.error)),r.readAsDataURL(e)})}c.addEventListener(`submit`,e=>{e.preventDefault(),J(l.value.trim()),sn()}),a.addEventListener(`click`,()=>{if(B()){J();return}on()}),l.addEventListener(`keydown`,e=>{e.key===`Escape`&&(e.stopPropagation(),sn())}),u.addEventListener(`click`,sn),s.addEventListener(`click`,sn),h.addEventListener(`click`,()=>{m.click()}),m.addEventListener(`change`,()=>{Qr(m.files?.[0])}),ae.addEventListener(`click`,()=>{ie.click()}),ie.addEventListener(`change`,()=>{$r(ie.files)}),le.addEventListener(`click`,()=>{ce.click()}),ce.addEventListener(`change`,()=>{ei(ce.files)}),pe.addEventListener(`click`,()=>{fe.click()}),fe.addEventListener(`change`,()=>{ti(fe.files)}),ee.addEventListener(`click`,()=>{Tn(ee.getAttribute(`aria-expanded`)===`true`)});async function ri(e){e.disabled=!0;let t=e.textContent;e.textContent=`opening...`;try{if(!(await fetch(`/api/application-materials/index/open`,{method:`POST`})).ok)throw Error(`Could not open the application material index.`)}catch(e){he.hidden=!1,he.textContent=e instanceof Error?e.message:`Could not open the application material index.`}finally{e.disabled=!1,e.textContent=t}}te.addEventListener(`click`,e=>{let t=e.target.closest(`[data-open-material-index]`);if(t){ri(t);return}let n=e.target.closest(`[data-material-view]`);if(n){On(n);return}let r=e.target.closest(`[data-material-remove]`);r&&kn(r)}),y.addEventListener(`click`,()=>{if(Qt?.scanning){Xr();return}Yr()}),i.addEventListener(`click`,e=>{let t=e.target.closest(`[data-review-role-id]`);if(t){gi(t.dataset.reviewRoleId);return}let n=e.target.closest(`[data-prep-role-id]`);if(n){vi(n.dataset.prepRoleId);return}let r=e.target.closest(`.job-action`);if(r){ii(r);return}let i=e.target.closest(`.pane-toggle`);if(!i)return;let a=i.parentElement.querySelector(`.pane-body`),o=i.getAttribute(`aria-expanded`)===`true`;i.setAttribute(`aria-expanded`,String(!o)),i.querySelector(`.chevron`).textContent=o?`>`:`v`,a.hidden=o,Ma()});async function ii(e){let{roleId:t,status:n}=e.dataset;if(!t||!n)return;let r=e.closest(`.job-actions`),i=e.closest(`.job`);r.querySelectorAll(`button`).forEach(e=>{e.disabled=!0}),e.textContent=`updating...`;try{let e=await fetch(`/api/roles/${encodeURIComponent(t)}/status`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:n})});if(!e.ok)throw Error(`Status update failed`);ai((await e.json()).role,i)}catch{r.querySelectorAll(`button`).forEach(e=>{e.disabled=!1}),e.textContent=n===`disinterested`?`disinterested`:n.toLowerCase()}}function ai(e,t){if(!e||!w)return;let n=t?.closest(`.status-pane`)?.dataset.bucket??e.role_status,r=e.role_status,i=si(e,n,r);ci(n,r),li(n,r),gn(),fi(w.statuses),mi(w.statuses),ui(t,i,n,r),Ma()}function oi(e){if(!e||!w)return null;let t=null;return w.statuses.forEach(n=>{let r=n.jobs.findIndex(t=>String(t.id)===String(e.id));r!==-1&&(t={...n.jobs[r],...e},n.jobs[r]=t)}),fi(w.statuses),mi(w.statuses),t}function si(e,t,n){let r=e;w.statuses.forEach(t=>{let n=t.jobs.findIndex(t=>String(t.id)===String(e.id));n!==-1&&(r={...t.jobs[n],...e},t.jobs.splice(n,1),t.count=t.jobs.length)});let i=w.statuses.find(e=>e.key===n);return i&&(i.jobs.unshift(r),i.count=i.jobs.length),r}function ci(e,t){w.statuses.forEach(e=>{let t=document.querySelector(`#status-${CSS.escape(e.key)}`);t?.classList.toggle(`empty`,e.count===0);let n=t?.querySelector(`.count`);n&&(n.textContent=e.count)}),[e,t].forEach(e=>{di(document.querySelector(`#status-${CSS.escape(e)}`))})}function li(e,t){if(!w.stats)return;let n=At.has(e),r=At.has(t);if(n===r){hn(w.stats);return}w.stats.applications_total=Number(w.stats.applications_total??0)+(r?1:-1),hn(w.stats)}function ui(e,t,n,r){let i=document.querySelector(`#status-${CSS.escape(r)}`),a=i?.querySelector(`.pane-body`);if(!e||!i||!a)return;e.remove(),di(document.querySelector(`#status-${CSS.escape(n)}`)),a.hidden=!1;let o=i.querySelector(`.pane-toggle`);o?.setAttribute(`aria-expanded`,`true`);let s=o?.querySelector(`.chevron`);s&&(s.textContent=`v`);let c=a.querySelector(`.jobs`);c||=(a.innerHTML=`<div class="jobs"></div>`,a.querySelector(`.jobs`)),c.insertAdjacentHTML(`afterbegin`,jn(t,r)),di(i)}function di(e){if(!e)return;let t=e.querySelector(`.pane-body`);if(!t)return;let n=t.querySelector(`.jobs`),r=!!n?.querySelector(`.job`),i=t.querySelector(`.empty-copy`);if(r){i?.remove();return}n?.remove(),i||t.insertAdjacentHTML(`beforeend`,`<p class="empty-copy">no jobs in this status.</p>`)}function fi(e){_e.disabled=pi(e).length===0,_e.setAttribute(`aria-label`,`review discovered`),_e.innerHTML=`<span class="review-discovered-label">review discovered</span>`}function pi(e=w?.statuses??[]){return e.find(e=>e.key===`discovered`)?.jobs??[]}function mi(e){ve.disabled=hi(e).length===0,ve.setAttribute(`aria-label`,`prep interested`),ve.innerHTML=`<span class="review-discovered-label">prep interested</span>`}function hi(e=w?.statuses??[]){return e.find(e=>e.key===`interested`)?.jobs??[]}function gi(e=null){let t=[...pi()],n=e==null?null:String(e);if(n){let e=t.findIndex(e=>String(e.id)===n);if(e>0){let[n]=t.splice(e,1);t.unshift(n)}}O=t,g.hidden=!1,document.body.classList.add(`review-open`),bi()}function _i(){g.hidden=!0,document.body.classList.remove(`review-open`),O=[]}function vi(e=null){let t=[...hi()].sort((e,t)=>Number(!!t.prep_started)-Number(!!e.prep_started)),n=e==null?null:String(e);if(n){let e=t.findIndex(e=>String(e.id)===n);if(e>0){let[n]=t.splice(e,1);t.unshift(n)}}k=t,_.hidden=!1,document.body.classList.add(`prep-open`),Ii()}function yi(){_.hidden=!0,document.body.classList.remove(`prep-open`),k=[]}function bi(e=``){let t=O[0],n=O.length,r=t?xi(t):``;if(ye.textContent=n>0?`review queue`:`review complete`,be.textContent=n>0?`${n} discovered ${n===1?`role`:`roles`} in queue`:``,g.querySelectorAll(`.review-action`).forEach(e=>{e.disabled=n===0}),!t){xe.innerHTML=`
  ...
  `}function xi(e){let t=Number(e.review_later_count??0);return t<=Ot?``:`role review has been postponed ${t} times. it is recommended to set it to disinterested.`}function Y(e,t,n=!1,r=``){if(!t)return``;let i=n?`<a href="${H(t)}" target="_blank" rel="noreferrer">${W(t)}</a>`:W(t);return`
  ...
  `:``}function Ci(e){let t=wi(String(e)).replace(/\u00a0/g,` `);if(Ti(t))return Ei(t);let n=t.split(/\r?\n/).map(e=>e.trim()).filter(Boolean),r=[],i=[],a=()=>{i.length!==0&&(r.push(`<ul>${i.map(e=>`<li>${e}</li>`).join(``)}</ul>`),i=[])};return n.forEach(e=>{let t=e.match(/^#{2,3}\s+(.+)$/);if(t){a(),r.push(`<h3>${W(t[1])}</h3>`);return}if(Pi(e)){a(),r.push(`<h3>${W(e.replace(/:$/,``))}</h3>`);return}let n=e.match(/^[-*]\s+(.+)$/);if(n){i.push(W(n[1]));return}a(),r.push(`<p>${W(e)}</p>`)}),a(),r.join(``)}function wi(e){let t=document.createElement(`textarea`);return t.innerHTML=e,t.value}function Ti(e){return/<\/?(?:a|br|div|em|h[1-6]|li|ol|p|span|strong|ul)\b/i.test(e)}function Ei(e){let t=document.createElement(`template`);t.innerHTML=e;let n=[];return Di(t.content.childNodes,n),n.join(``)}function Di(e,t){e.forEach(e=>{if(e.nodeType===Node.TEXT_NODE){let n=Mi(e.textContent);n&&t.push(`<p>${W(n)}</p>`);return}if(e.nodeType!==Node.ELEMENT_NODE)return;let n=e,r=n.tagName.toLowerCase();if(r===`script`||r===`style`||r===`br`)return;if(/^h[1-6]$/.test(r)){ki(t,n.textContent);return}if(r===`ul`||r===`ol`){let e=Ai(n);e&&t.push(e);return}if(r===`p`){Oi(n,t);return}let i=Array.from(n.children).some(e=>[`DIV`,`H1`,`H2`,`H3`,`H4`,`H5`,`H6`,`OL`,`P`,`UL`].includes(e.tagName));if([`article`,`div`,`section`].includes(r)&&i){Di(n.childNodes,t);return}let a=Array.from(n.children).filter(e=>[`UL`,`OL`].includes(e.tagName)),o=Mi(ji(n));if(o&&(Ni(o,n)?ki(t,o):t.push(`<p>${W(o)}</p>`)),a.length>0){a.forEach(e=>{let n=Ai(e);n&&t.push(n)});return}!o&&i&&Di(n.childNodes,t)})}function Oi(e,t){if(!e.querySelector(`br`)){let n=Mi(ji(e));if(!n)return;Ni(n,e)?ki(t,n):t.push(`<p>${W(n)}</p>`);return}let n=``,r=()=>{let r=Mi(n);n=``,r&&(Ni(r,e)?ki(t,r):t.push(`<p>${W(r)}</p>`))};e.childNodes.forEach(e=>{if(e.nodeType===Node.ELEMENT_NODE&&e.tagName.toLowerCase()===`br`){r();return}n+=` ${e.textContent??``}`}),r()}function ki(e,t){let n=Mi(t).replace(/:$/,``);n&&e.push(`<h3>${W(n)}</h3>`)}function Ai(e){let t=Array.from(e.children).filter(e=>e.tagName===`LI`).map(e=>{let t=Mi(ji(e)),n=Array.from(e.children).filter(e=>[`UL`,`OL`].includes(e.tagName)).map(e=>Ai(e)).filter(Boolean).join(``);return t||n?`<li>${W(t)}${n}</li>`:``}).filter(Boolean);return t.length>0?`<ul>${t.join(``)}</ul>`:``}function ji(e){let t=e.cloneNode(!0);return t.querySelectorAll(`ul, ol`).forEach(e=>{e.remove()}),t.textContent}function Mi(e){return String(e??``).replace(/\s+/g,` `).trim()}function Ni(e,t){let n=e.replace(/:$/,``).trim();return!n||n.length>90?!1:Pi(n)||/:$/.test(e)?!0:/[.!?]$/.test(n)||n.split(/\s+/).length>10?!1:t.querySelector(`strong, b, u`)?!0:Pi(n)}function Pi(e){return Mt.test(String(e).trim())}async function Fi(e){let t=O[0];if(!t)return;if(e===`later`){g.querySelectorAll(`.review-action`).forEach(e=>{e.disabled=!0});try{let e=await aa(t.id);O.shift(),oi(e),bi(`moved out of this review pass.`)}catch{bi(`could not postpone that role. try again.`)}finally{g.querySelectorAll(`.review-action`).forEach(e=>{e.disabled=O.length===0})}return}if(![`interested`,`disinterested`].includes(e))return;let n=g.querySelectorAll(`.review-action`);n.forEach(e=>{e.disabled=!0});try{let n=await oa(t.id,e);O.shift(),bi(e===`interested`?`marked interested.`:`marked disinterested.`),ai(n,document.querySelector(`.job[data-role-id="${CSS.escape(String(t.id))}"]`))}catch{n.forEach(e=>{e.disabled=!1}),bi(`could not update that role. try again.`)}}async function Ii(e=``){let t=k[0],n=k.length;if(Ce.textContent=n>0?`prep queue`:`prep complete`,we.textContent=n>0?`${n} interested ${n===1?`role`:`roles`} in queue`:``,_.querySelectorAll(`.review-action`).forEach(e=>{e.disabled=n===0}),!t){v.innerHTML=`
      <div class="review-empty">
  ...
  `}function zi(e,t={}){let n=t.messages??Rt.get(e.id)??[],r=!!t.loading;return`
  ...
  `}function Vi(e,t={}){let n=M.get(e.id),r=t.coverLetter??n,i=t.tweaks??r?.tweaks??``,a=`/api/roles/${encodeURIComponent(e.id)}/cover-letter.pdf`;return t.loading?`
  ...
  `}function X(e,t={}){let n=A.get(e.id);if(!t.loading&&!t.error&&!t.analysis&&n)return X(e,{analysis:n});if(!t.loading&&!t.error&&!t.analysis)return`
  ...
  `}function Hi(e){return e?.tweak_prompt?`
  ...
  `:`
    ...
    `}async function Ui(e,t={}){if(!t.force&&A.has(e))return A.get(e);let n=await fetch(`/api/roles/${encodeURIComponent(e)}/prep-analysis`);if(!n.ok)throw Error(`Prep analysis request failed`);let r=await n.json();return r.analysis.resources=r.resources??[],A.set(e,r.analysis),r.analysis}function Z(e){let t=document.createElement(`template`);return t.innerHTML=e.trim(),t.content.firstElementChild}async function Wi(e){let t=k[0];if(!t)return;let n=_.querySelectorAll(`.review-action`);if(n.forEach(e=>{e.disabled=!0}),e===`later`){try{await aa(t.id),t.review_later_count=Number(t.review_later_count??0)+1,k.length>1?(k.push(k.shift()),Ii(`moved to the back of the prep queue.`)):Ii(`only one role is in the prep queue.`)}catch{Ii(`could not postpone prep. try again.`)}return}if(e===`applied`)try{let e=await oa(t.id,`applied`);k.shift(),Ii(`moved to applied.`),ai(e,document.querySelector(`.job[data-role-id="${CSS.escape(String(t.id))}"]`))}catch{n.forEach(e=>{e.disabled=!1}),Ii(`could not move that role. try again.`)}}async function Gi(e,t,n,r){let i=await fetch(`/api/roles/${encodeURIComponent(e)}/prep-feedback`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({feedback_index:t,feedback_item:n,comment:r})});if(!i.ok)throw Error(`Prep feedback update failed`);return i.json()}async function Ki(e,t,n,r){let i=await fetch(`/api/roles/${encodeURIComponent(e)}/prep-feedback-ignore`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({feedback_index:t,feedback_item:n,comment:r})});if(!i.ok)throw Error(`Prep feedback ignore failed`);return i.json()}async function qi(e,{force:t=!1}={}){if(!t&&j.has(e))return j.get(e);let n=await fetch(`/api/roles/${encodeURIComponent(e)}/resume`);if(!n.ok)throw Error(`Resume request failed`);let r=await n.json();return r.resume&&j.set(e,r.resume),r.resume}async function Ji(e,t){let n=await fetch(`/api/roles/${encodeURIComponent(e)}/resume/save`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({latex:t})});if(!n.ok)throw Error(`Resume save failed`);return n.json()}async function Yi(e,t,n){let r=await fetch(`/api/roles/${encodeURIComponent(e)}/resume`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({tweaks:t,previous_latex:n})});if(!r.ok)throw Error(`Resume generation failed`);return r.json()}async function Xi(e,t){let n=await fetch(`/api/roles/${encodeURIComponent(e)}/chat`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({messages:t})});if(!n.ok)throw Error(`Role chat failed`);return n.json()}function Zi(e,t,n=kt){let r=zt.get(e)??{timer:null,saving:!1,version:0,latex:``};r.version+=1,r.latex=t,r.timer&&clearTimeout(r.timer),r.timer=setTimeout(()=>{r.timer=null,Qi(e)},n),zt.set(e,r)}async function Qi(e){let t=zt.get(e);if(!t||t.saving)return;t.saving=!0;let n=t.version,r=t.latex;try{let i=await Ji(e,r);t.version===n&&(j.set(e,i.resume),$i(`resume`,e,i.resume))}catch{}finally{t.saving=!1,t.version!==n&&Zi(e,t.latex,0)}}function $i(e,t,n){if(!n?.pdf_base64)return;let r=e===`resume`?`[data-prep-resume-latex="${t}"]`:`[data-prep-cover-letter-latex="${t}"]`,i=v.querySelector(r)?.closest(`.prep-panel`),a=i?.querySelector(`.prep-cover-pdf`),o=i?.querySelector(`.prep-cover-pdf-link`),s=e===`resume`?`/api/roles/${encodeURIComponent(t)}/resume.pdf`:`/api/roles/${encodeURIComponent(t)}/cover-letter.pdf`;a&&(a.src=`${s}?v=${Date.now()}`),o&&(o.href=s)}async function ea(e,t=``,n=``){let r=await fetch(`/api/roles/${encodeURIComponent(e)}/cover-letter`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({tweaks:t,previous_latex:n})});if(!r.ok)throw Error(`Cover letter generation failed`);return r.json()}async function ta(e,t){let n=await fetch(`/api/roles/${encodeURIComponent(e)}/cover-letter/save`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({latex:t})});if(!n.ok)throw Error(`Cover letter save failed`);return n.json()}function na(e,t,n=``,r=kt){let i=Bt.get(e)??{timer:null,saving:!1,version:0,latex:``,tweaks:``};i.version+=1,i.latex=t,i.tweaks=n,i.timer&&clearTimeout(i.timer),i.timer=setTimeout(()=>{i.timer=null,ra(e)},r),Bt.set(e,i)}async function ra(e){let t=Bt.get(e);if(!t||t.saving)return;t.saving=!0;let n=t.version,r=t.latex,i=t.tweaks;try{let a=await ta(e,r);t.version===n&&(M.set(e,{...a.cover_letter,tweaks:i}),$i(`coverLetter`,e,a.cover_letter))}catch{}finally{t.saving=!1,t.version!==n&&na(e,t.latex,t.tweaks,0)}}async function ia(e){if(M.has(e))return M.get(e);let t=await fetch(`/api/roles/${encodeURIComponent(e)}/cover-letter`);if(!t.ok)throw Error(`Cover letter request failed`);let n=await t.json();return n.cover_letter&&M.set(e,n.cover_letter),n.cover_letter}async function aa(e){let t=await fetch(`/api/roles/${encodeURIComponent(e)}/review-later`,{method:`POST`});if(!t.ok)throw Error(`Review later update failed`);return(await t.json()).role}async function oa(e,t){let n=await fetch(`/api/roles/${encodeURIComponent(e)}/status`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})});if(!n.ok)throw Error(`Status update failed`);return(await n.json()).role}function sa(e){return`${e}-${globalThis.crypto?.randomUUID?.()??`${Date.now()}-${Math.random()}`}`}function ca(e){window.location.hash!==e&&window.history.pushState({},``,e||`${window.location.pathname}${window.location.search}`)}async function la({seedJobs:e=null}={}){De.hidden=!1,document.body.classList.add(`prepped-open`),ca(`#prepped-roles`),e?(N=e,P=P??N[0]?.role_id??null,$()):N.length===0&&(ke.textContent=`loading prepared roles...`),await da(),fa()}function ua({clearHash:e=!0}={}){De.hidden=!0,document.body.classList.remove(`prepped-open`),pa(),L.clear(),R.forEach(e=>URL.revokeObjectURL(e)),R.clear(),Gt.clear(),Kt.clear(),e&&window.location.hash===`#prepped-roles`&&ca(``)}window.addEventListener(`pagehide`,()=>{document.querySelectorAll(`[data-preview-blob-url]`).forEach(e=>{URL.revokeObjectURL(e.dataset.previewBlobUrl)}),R.forEach(e=>URL.revokeObjectURL(e)),R.clear(),Gt.clear()});async function da(){try{let e=await fetch(`/api/autoprep/jobs`);if(!e.ok)throw Error(`Prepped roles request failed`);let t=await e.json();N=t.jobs??[];let n=t.bulk_cover_letter_regeneration;if(n){let e=Array.isArray(n.jobs)?n.jobs:[];I={idempotencyKey:n.idempotency_key,roleIds:e.map(e=>Number(e.role_id)),jobs:e,skipped:Array.isArray(n.skipped)?n.skipped:[]}}N.some(e=>Number(e.role_id)===Number(P))||(P=N[0]?.role_id??null),$()}catch{ke.textContent=`could not refresh preparation progress.`}}function fa(){pa(),N.some(ma)&&(Vt=window.setInterval(da,2e3))}function pa(){Vt!==null&&window.clearInterval(Vt),Vt=null}function ma(e){return[`queued`,`generating_resume_tweaks`,`regenerating_resume`,`generating_cover_letter`].includes(e.overall_status)}function ha(e){return[e.resume_status,e.cover_letter_status].some(e=>[`failed`,`interrupted`].includes(e))}function ga(e){return e.cover_letter_status===`generating`||e.overall_status===`generating_cover_letter`}function _a(e){return{queued:`Queued`,generating_resume_tweaks:`Generating resume tweaks`,regenerating_resume:`Regenerating resume`,generating_cover_letter:`Generating cover letter`,partially_complete:`Partially complete`,ready:`Ready`,failed:`Failed`,interrupted:`Interrupted`,generating_tweaks:`Generating tweaks`,regenerating:`Regenerating`,generating:`Generating`}[e]??U(e)}function va(e,t){let n=t===`cover-letter`?`cover_letter`:`resume`;return`${e.updated_at||``}:${e[`${n}_artifact_path`]||``}`}function Q(e,{close:t=!1}={}){let n=R.get(e);n&&URL.revokeObjectURL(n),R.delete(e),Gt.delete(e),Kt.delete(e),t&&L.delete(e)}function ya(){Gt.forEach((e,t)=>{let[n,r]=t.split(`:`),i=N.find(e=>Number(e.role_id)===Number(n));(!i||va(i,r)!==e)&&Q(t,{close:!0})})}function ba(){if(!I)return;let e=I.jobs||N,t=new Map(e.map(e=>[Number(e.role_id),e])),n=I.roleIds.map(e=>t.get(Number(e))),r=n.filter(e=>e?.worker_state===`idle`&&e.cover_letter_status===`ready`).length,i=n.filter(e=>!e||e.worker_state===`idle`&&[`failed`,`interrupted`].includes(e.cover_letter_status)),a=n.length-r-i.length,o=I.skipped.length?` Skipped before queueing: ${I.skipped.map(e=>`${e.company_name} — ${e.title}: ${e.reason}`).join(` · `)}`:``,s=i.length?` Queued regeneration failures: ${i.map(e=>e?`${e.company_name} — ${e.title}: ${e.cover_letter_error||`generation failed`}`:`A role left the Prepped queue before regeneration completed`).join(` · `)}`:``;F=n.length?a>0?`Cover-letter regeneration in progress: ${r} of ${n.length} complete · ${a} remaining.${o}${s}`:`Cover-letter regeneration complete: ${r} succeeded, ${i.length} failed.${o}${s}`:`No cover letters were queued.${o}`}function $(){ya(),ba();let e=N.filter(ma).length,t=N.filter(e=>e.worker_state===`idle`&&e.cover_letter_status===`ready`).length;ke.textContent=N.length?`${N.length} prepped ${N.length===1?`role`:`roles`}${e?` · ${e} in progress`:``}`:`No queued or prepared roles.`,Ae.disabled=Ht||t===0,Ae.setAttribute(`aria-busy`,Ht?`true`:`false`),Ae.textContent=Ht?`queuing cover letters...`:`regenerate all cover letters`,je.textContent=F,Me.innerHTML=N.map(e=>{let t=ha(e),n=!t&&ga(e),r=Number(e.role_id)===Number(P)?` is-active`:``;return`
      <button type="button" class="prepped-list-item${n?` is-cover-letter-generating`:``}${t?` has-generation-failure`:``}${r}" data-prepped-role="${e.role_id}">
        <strong>${W(e.company_name)}</strong><span>${W(e.title)}</span>
        <small class="status-${H(e.overall_status)}">${H(_a(e.overall_status))}</small>
      </button>`}).join(``),xa(),fa()}function xa(){let e=N.findIndex(e=>Number(e.role_id)===Number(P)),t=N[e];if(!t){Ne.innerHTML=`<div class="prepped-empty"><h3>nothing prepped yet.</h3><p>Queue Interested roles from Autoprep Interested.</p></div>`;return}let n=W(t.title),r=ln(t.role_url),i=r?`<a class="prepped-role-link" href="${H(r)}" target="_blank" rel="noopener noreferrer">${n}<span aria-hidden="true">↗</span></a>`:n,a=[[`Location`,t.location||`Unavailable`],[`Added`,V(t.date_added||t.created_at)||`Unavailable`],[`Last seen`,V(t.last_seen_at)||`Unavailable`],[`Posting ID`,t.posting_id||`Unavailable`]],o=Ut.has(Number(t.role_id)),s=o||ma(t);Ne.innerHTML=`
    <header class="prepped-detail-heading">
      <div><p class="eyebrow">${W(t.company_name)}</p><h3>${i}</h3></div>
      <span class="prepped-status status-${H(t.overall_status)}">${H(_a(t.overall_status))}</span>
    </header>
...
`,`<br>`)}</div>
    ...
    ${t.notes?`<details class="prepped-role-description"><summary>Role notes</summary><div class="prepped-description-copy">${W(t.notes).replaceAll(`
`,`<br>`)}</div></details>`:``}
    <div class="prepped-document-grid">
      ${Ca(t,`resume`,`Resume`)}
      ${Ca(t,`cover-letter`,`Cover letter`)}
    </div>
    ...
    <p class="prepped-safety-note">Autoprep prepares files only. It never submits an application.</p>`}async function Sa(e,t){let n=`${e.role_id}:${t}`,r=va(e,t);if(!(Gt.get(n)===r||qt.has(n))){Q(n),qt.add(n),Kt.delete(n),xa();try{let i=await Dn(`/api/autoprep/roles/${encodeURIComponent(e.role_id)}/documents/${t}.pdf?v=${encodeURIComponent(e.updated_at||``)}`),a=N.find(t=>Number(t.role_id)===Number(e.role_id));if(!L.has(n)||!a||va(a,t)!==r){URL.revokeObjectURL(i),L.delete(n);return}R.set(n,i),Gt.set(n,r)}catch(e){Kt.set(n,e instanceof Error?e.message:`PDF preview unavailable`)}finally{qt.delete(n),Number(P)===Number(e.role_id)&&xa()}}}function Ca(e,t,n){let r=t===`cover-letter`?`cover_letter`:`resume`,i=e[`${r}_status`],a=e[`${r}_artifact_path`],o=a?.split(`/`).pop()??`Not available`,s=e[`${r}_error`],c=e[`${r}_instruction`]||``,l=`${e.role_id}:${t}`,u=Wt.get(l)??c,d=t===`cover-letter`?`Optional comments for the next version`:`Comments for the next version`,ee=t===`cover-letter`?`Optionally describe specific, truthful changes...`:`Describe specific, truthful changes...`,te=[`failed`,`interrupted`].includes(i),f=e.worker_state!==`idle`||[`queued`,`generating`,`generating_tweaks`,`regenerating`].includes(i),ne=!f&&(i===`ready`||te)&&(te||t===`cover-letter`||String(u).trim()),p=L.has(l),m=`/api/autoprep/roles/${encodeURIComponent(e.role_id)}/documents/${t}.pdf?v=${encodeURIComponent(e.updated_at||``)}`,h=R.get(l),re=Kt.get(l),ie=qt.has(l),ae=a?`<a class="prep-cover-pdf-link" data-autoprep-view="${t}" href="${H(m)}" target="_blank" rel="noreferrer" aria-label="View ${H(n.toLowerCase())} PDF in browser">View PDF</a>`:``;return`
    <section class="prepped-document${p?` has-open-preview`:``} status-${H(i)}">
      <div class="prepped-document-heading"><h4>${H(n)}</h4><span>${H(_a(i))}</span></div>
      ...
      <div class="prepped-pdf-preview" data-autoprep-preview-panel="${t}" ${p&&a?``:`hidden`}>
        ${p&&h?`<iframe title="${H(n)} PDF preview" src="${H(h)}"></iframe>`:``}
        ${p&&ie?`<p>Loading PDF preview...</p>`:``}
        ${p&&re?`<p class="prepped-error">${W(re)}</p>`:``}
      </div>
      <label class="prepped-comments-label" for="prepped-comments-${H(l)}">${d}</label>
      <textarea id="prepped-comments-${H(l)}" data-autoprep-comments="${t}" rows="4" placeholder="${ee}" ${f?`disabled`:``}>${W(u)}</textarea>
      <button class="prepped-regenerate" type="button" data-autoprep-regenerate="${t}" ${ne?``:`disabled`}>${f?`Regenerating...`:`Regenerate ${H(n)}`}</button>
    </section>`}async function wa(e,t,n){if(n.disabled)return;let r=`${e.role_id}:${t}`,i=e[`${t===`cover-letter`?`cover_letter`:`resume`}_status`],a=[`failed`,`interrupted`].includes(i),o=Ne.querySelector(`[data-autoprep-comments="${t}"]`),s=String(o?.value||Wt.get(r)||``).trim();if(!s&&t!==`cover-letter`&&!a){o?.focus();return}n.disabled=!0,n.textContent=`Queuing regeneration...`;try{let n=await fetch(`/api/autoprep/roles/${encodeURIComponent(e.role_id)}/${a?`retry`:`regenerate`}/${t}`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(a?{idempotency_key:sa(`retry-${t}`)}:{comments:s,idempotency_key:sa(`regenerate-${t}`)})}),i=await n.json();if(!n.ok)throw Error(i.error||`Regeneration request failed`);Wt.delete(r),Q(r,{close:!0});let o=N.findIndex(t=>Number(t.role_id)===Number(e.role_id));o>=0&&(N[o]=i.job),$()}catch(e){window.alert(e instanceof Error?e.message:`Regeneration request failed`),await da()}}async function Ta(){if(!Ht){Ht=!0,I=null,F=`Queuing eligible cover letters...`,$();try{let e=await fetch(`/api/autoprep/cover-letters/regenerate`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({idempotency_key:sa(`regenerate-all-cover-letters`)})}),t=await e.json();if(!e.ok)throw Error(t.error||`Bulk regeneration request failed`);let n=Number(t.queued_count||0),r=Array.isArray(t.skipped)?t.skipped:[];I={roleIds:(t.jobs||[]).map(e=>Number(e.role_id)),jobs:t.jobs||[],skipped:r},!n&&!r.length&&(I=null,F=`No prepped roles are available to regenerate.`),(t.jobs||[]).forEach(e=>{let t=N.findIndex(t=>Number(t.role_id)===Number(e.role_id));t>=0&&(N[t]=e),Q(`${e.role_id}:cover-letter`,{close:!0})}),await da(),fa()}catch(e){I=null,F=e instanceof Error?e.message:`Bulk regeneration request failed`}finally{Ht=!1,$()}}}async function Ea(e,t){let n=Number(e);if(Ut.has(n))return;Ut.add(n),t.disabled=!0,t.setAttribute(`aria-busy`,`true`),t.textContent=`Moving to Disinterested...`;let r=N.findIndex(e=>Number(e.role_id)===n);try{await oa(e,`disinterested`),Q(`${e}:resume`,{close:!0}),Q(`${e}:cover-letter`,{close:!0}),r>=0&&N.splice(r,1),P=N[Math.min(r,N.length-1)]?.role_id??null,F=`Role moved to Disinterested.`,$(),Cr()}catch(e){F=e instanceof Error?e.message:`Could not move this role to Disinterested.`,await da()}finally{Ut.delete(n),N.some(e=>Number(e.role_id)===n)&&$()}}async function Da(e,t){if(t.disabled)return;t.disabled=!0,t.textContent=`Moving to Applied...`;let n=N.findIndex(t=>Number(t.role_id)===Number(e));try{if(!(await fetch(`/api/autoprep/roles/${encodeURIComponent(e)}/applied`,{method:`POST`})).ok)throw Error(`Applied update failed`);Q(`${e}:resume`,{close:!0}),Q(`${e}:cover-letter`,{close:!0}),N.splice(n,1),P=N[Math.min(n,N.length-1)]?.role_id??null,$(),Cr()}catch{await da()}}_e.addEventListener(`click`,gi),Se.addEventListener(`click`,_i),ve.addEventListener(`click`,vi),Ee.addEventListener(`click`,()=>la()),Oe.addEventListener(`click`,ua),Ae.addEventListener(`click`,Ta),Me.addEventListener(`click`,e=>{let t=e.target.closest(`[data-prepped-role]`);t&&(P=Number(t.dataset.preppedRole),$())}),Ne.addEventListener(`input`,e=>{let t=e.target.closest(`[data-autoprep-comments]`);if(!t)return;let n=`${P}:${t.dataset.autoprepComments}`;Wt.set(n,t.value);let r=Ne.querySelector(`[data-autoprep-regenerate="${t.dataset.autoprepComments}"]`),i=N.find(e=>Number(e.role_id)===Number(P)),a=t.dataset.autoprepComments===`cover-letter`?`cover_letter`:`resume`,o=i?.[`${a}_status`],s=[`failed`,`interrupted`].includes(o);r&&(r.disabled=i?.worker_state!==`idle`||![`ready`,`failed`,`interrupted`].includes(o)||!s&&t.dataset.autoprepComments!==`cover-letter`&&!t.value.trim())}),Ne.addEventListener(`click`,async e=>{let t=N.find(e=>Number(e.role_id)===Number(P));if(!t)return;let n=e.target.closest(`[data-prepped-nav]`);if(n){let e=N.indexOf(t),r=n.dataset.preppedNav===`next`?1:-1;P=N[e+r]?.role_id??t.role_id,$();return}let r=e.target.closest(`[data-autoprep-preview]`);if(r){let e=r.dataset.autoprepPreview,n=`${t.role_id}:${e}`;L.has(n)?(L.delete(n),xa()):(L.add(n),xa(),Sa(t,e));return}let i=e.target.closest(`[data-autoprep-regenerate]`);if(i){wa(t,i.dataset.autoprepRegenerate,i);return}let a=e.target.closest(`[data-autoprep-open-folder]`);if(a&&!a.disabled){a.disabled=!0,a.textContent=`Opening...`;try{if(!(await fetch(`/api/autoprep/roles/${encodeURIComponent(t.role_id)}/open-folder`,{method:`POST`})).ok)throw Error(`Could not open the documents folder.`);a.textContent=`Opened in Finder`,window.setTimeout(()=>{a.isConnected&&(a.textContent=`Open Documents Folder`,a.disabled=!1)},1500)}catch(e){a.textContent=e instanceof Error?e.message:`Could not open folder`,a.disabled=!1}return}let o=e.target.closest(`[data-autoprep-disinterested]`);if(o){Ea(t.role_id,o);return}let s=e.target.closest(`[data-autoprep-applied]`);s&&Da(t.role_id,s)}),Te.addEventListener(`click`,yi),g.addEventListener(`click`,e=>{let t=e.target.closest(`[data-review-action]`);t&&Fi(t.dataset.reviewAction)}),_.addEventListener(`click`,e=>{e.target.closest(`.prep-summary-action`)&&e.stopPropagation()}),_.addEventListener(`input`,e=>{let t=e.target.closest(`[data-prep-resume-tweaks]`);if(t){let e=Number(t.dataset.prepResumeTweaks);Number.isFinite(e)&&Lt.set(e,t.value);return}let n=e.target.closest(`[data-prep-resume-latex]`);if(n){let e=Number(n.dataset.prepResumeLatex);if(!Number.isFinite(e))return;Zi(e,n.value);return}let r=e.target.closest(`[data-prep-cover-letter-latex]`);if(!r)return;let i=Number(r.dataset.prepCoverLetterLatex);if(!Number.isFinite(i))return;let a=r.closest(`.prep-cover-letter`)?.querySelector(`[data-prep-cover-letter-tweaks="${i}"]`)?.value??``;na(i,r.value,a)}),_.addEventListener(`scroll`,e=>{e.target.closest(`[data-prep-resume-latex], [data-prep-cover-letter-latex]`)},!0),_.addEventListener(`focusout`,e=>{let t=e.target.closest(`[data-prep-resume-latex]`);if(t){let e=Number(t.dataset.prepResumeLatex);if(!Number.isFinite(e))return;Zi(e,t.value,0);return}let n=e.target.closest(`[data-prep-cover-letter-latex]`);if(!n)return;let r=Number(n.dataset.prepCoverLetterLatex);if(!Number.isFinite(r))return;let i=n.closest(`.prep-cover-letter`)?.querySelector(`[data-prep-cover-letter-tweaks="${r}"]`)?.value??``;na(r,n.value,i,0)}),_.addEventListener(`submit`,async e=>{let t=e.target.closest(`[data-prep-role-chat-form]`);if(!t||!k[0])return;e.preventDefault();let n=Number(t.dataset.prepRoleChatForm);if(!Number.isFinite(n))return;let r=t.querySelector(`[data-prep-role-chat-input="${n}"]`),i=r?.value?.trim()??``;if(!i){r?.focus();return}let a=[...Rt.get(n)??[],{role:`user`,content:i}];Rt.set(n,a),v.querySelector(`.prep-role-chat`)?.replaceWith(Z(zi(k[0],{messages:a,loading:!0})));try{let e=await Xi(n,a),t=[...a,e.message];Rt.set(n,t),v.querySelector(`.prep-role-chat`)?.replaceWith(Z(zi(k[0],{messages:t})))}catch{let e=[...a,{role:`assistant`,content:`could not answer right now.`}];Rt.set(n,e),v.querySelector(`.prep-role-chat`)?.replaceWith(Z(zi(k[0],{messages:e})))}}),_.addEventListener(`click`,async e=>{let t=e.target.closest(`[data-prep-section-target]`);if(t){let e=t.dataset.prepSectionTarget,n=e?document.getElementById(e):null;if(n instanceof HTMLDetailsElement){n.open=!0,n.scrollIntoView({behavior:`smooth`,block:`start`});let e=n.querySelector(`summary`);e?.setAttribute(`tabindex`,`-1`),e?.focus({preventScroll:!0})}return}if(e.target.closest(`[data-prep-analysis]`)&&k[0]){let e=k[0].id;v.querySelector(`.prep-analysis`)?.replaceWith(Z(X(k[0],{loading:!0})));try{let t=await Ui(e,{force:!0});if(k[0]?.id!==e)return;v.querySelector(`.prep-analysis`)?.replaceWith(Z(X(k[0],{analysis:t})))}catch{v.querySelector(`.prep-analysis`)?.replaceWith(Z(X(k[0],{error:!0})))}return}if(e.target.closest(`[data-prep-resume-regenerate]`)&&k[0]){let e=k[0].id,t=v.querySelector(`.prep-resume`),n=t?.querySelector(`[data-prep-resume-tweaks="${e}"]`)?.value??``,r=t?.querySelector(`[data-prep-resume-latex="${e}"]`)?.value??``;if(!n.trim()){t?.querySelector(`[data-prep-resume-tweaks="${e}"]`)?.focus();return}Lt.set(e,n),t?.replaceWith(Z(Li(k[0],{loading:!0})));try{let t=await Yi(e,n,r);j.set(e,t.resume),v.querySelector(`.prep-resume`)?.replaceWith(Z(Li(k[0],{resume:t.resume}))),G()}catch{v.querySelector(`.prep-resume`)?.replaceWith(Z(Li(k[0],{resume:j.get(e),tweaks:n}))),G()}return}if(e.target.closest(`[data-prep-cover-letter]`)&&k[0]){let e=k[0].id,t=v.querySelector(`.prep-cover-letter`),n=t?.querySelector(`[data-prep-cover-letter-tweaks="${e}"]`)?.value??``,r=n.trim()?t?.querySelector(`[data-prep-cover-letter-latex="${e}"]`)?.value??``:``;t?.replaceWith(Z(Vi(k[0],{loading:!0})));try{let t=await ea(e,n,r);M.set(e,t.cover_letter),v.querySelector(`.prep-cover-letter`)?.replaceWith(Z(Vi(k[0],{coverLetter:t.cover_letter}))),G()}catch{v.querySelector(`.prep-cover-letter`)?.replaceWith(Z(Vi(k[0],{coverLetter:M.get(e),tweaks:n}))),G()}return}let n=e.target.closest(`[data-prep-action]`);if(n){Wi(n.dataset.prepAction);return}let r=e.target.closest(`[data-prep-feedback]`);if(!r||!k[0])return;let i=k[0].id,a=A.get(i),o=Array.isArray(a?.feedback_items)?a.feedback_items.length:0,s=It.get(i)??0;if(r.dataset.prepFeedback===`accept`||r.dataset.prepFeedback===`ignore`){let e=a?.feedback_items?.[s];if(!e)return;let t=v.querySelector(`[data-prep-feedback-comment]`)?.value??``,n=r.dataset.prepFeedback,o=n;r.disabled=!0,r.textContent=n===`accept`?`adding...`:`ignoring...`;try{if(n===`accept`){let n=await Gi(i,s,e,t),r=document.querySelector(`.job[data-role-id="${CSS.escape(String(i))}"]`);n.role&&(k[0]=n.role,ai(n.role,r)),ka(i,n.tweak_prompt??e.tweak_prompt??``),Oa(i,s,a)}else await Ki(i,s,e,t),Oa(i,s,a)}catch{r.disabled=!1,r.textContent=o}return}let c=r.dataset.prepFeedback===`next`?1:-1;It.set(i,Math.max(0,Math.min(s+c,o-1))),v.querySelector(`.prep-analysis`)?.replaceWith(Z(X(k[0],{analysis:a})))});function Oa(e,t,n){let r=n.feedback_items.filter((e,n)=>n!==t),i=Math.min(t,Math.max(r.length-1,0)),a={...n,feedback_items:r,verdict:r.length===0?`ready_to_apply`:n.verdict};It.set(e,i),A.set(e,a),v.querySelector(`.prep-analysis`)?.replaceWith(Z(X(k[0],{analysis:a})))}function ka(e,t){let n=String(t||``).trim();if(!n)return;let r=Lt.get(e)?.trim()??``,i=r?`${r}\n\n${n}`:n;Lt.set(e,i);let a=v.querySelector(`[data-prep-resume-tweaks="${e}"]`);a&&(a.value=i,a.focus())}document.addEventListener(`keydown`,e=>{e.key===`Escape`&&!Re.hidden&&Gn(),e.key===`Escape`&&!o.hidden&&sn(),e.key===`Escape`&&!g.hidden&&_i(),e.key===`Escape`&&!_.hidden&&yi(),e.key===`Escape`&&!De.hidden&&ua(),e.key===`Escape`&&!Ke.hidden&&$n(),e.key===`Escape`&&!st.hidden&&sr(),e.key===`Escape`&&!mt.hidden&&gr(),e.key===`Escape`&&!bt.hidden&&Mr()}),Le.addEventListener(`click`,Wn),Be.addEventListener(`click`,Gn),ze.addEventListener(`click`,Gn);function Aa(){return Array.from(document.querySelectorAll(`.pane-toggle`))}function ja(){return Aa().some(e=>e.getAttribute(`aria-expanded`)===`true`)}function Ma(){He.textContent=ja()?`collapse all`:`expand all`}function Na(){document.querySelectorAll(`.pane-toggle`).forEach(e=>{e.setAttribute(`aria-expanded`,`true`),e.querySelector(`.chevron`).textContent=`v`,e.parentElement.querySelector(`.pane-body`).hidden=!1})}function Pa(){document.querySelectorAll(`.job[open]`).forEach(e=>{e.open=!1}),document.querySelectorAll(`.pane-toggle`).forEach(e=>{e.setAttribute(`aria-expanded`,`false`),e.querySelector(`.chevron`).textContent=`>`,e.parentElement.querySelector(`.pane-body`).hidden=!0})}He.addEventListener(`click`,()=>{ja()?Pa():Na(),Ma()}),Ue.addEventListener(`click`,()=>{Nt=!Nt,Ue.textContent=Nt?`show empty`:`hide empty`,w&&An(w.statuses)}),Ge.addEventListener(`click`,Qn),qe.addEventListener(`click`,$n),ot.addEventListener(`click`,or),ct.addEventListener(`click`,sr),pt.addEventListener(`click`,hr),ht.addEventListener(`click`,gr),Pe.addEventListener(`click`,jr),xt.addEventListener(`click`,Mr),St.addEventListener(`submit`,e=>{e.preventDefault(),Fr(St).catch(()=>{S.textContent=`could not add company.`})}),Ct.addEventListener(`submit`,e=>{e.preventDefault(),Br(Ct).catch(()=>{Dt.textContent=`could not add role.`})}),C.addEventListener(`submit`,e=>{let t=e.target.closest(`[data-company-link-form]`);t&&(e.preventDefault(),Ir(t).catch(()=>{S.textContent=`could not add link.`}))}),C.addEventListener(`input`,e=>{let t=e.target.closest(`[data-company-notes]`);t&&Ur(t.dataset.companyNotes)}),C.addEventListener(`change`,e=>{let t=e.target.closest(`[data-company-tier]`);if(!t)return;let n=t.closest(`.company-panel`);n&&Gr(n,t.value),window.clearTimeout(rn.get(t.dataset.companyTier)),Wr(t.dataset.companyTier).catch(()=>{Hr(`could not save company.`)})}),C.addEventListener(`click`,e=>{let t=e.target.closest(`[data-delete-company]`);if(t){let e=Vr(t.dataset.deleteCompany),n=e?.name?U(e.name):`this company`;if(!window.confirm(`Deactivate ${n}? It will be hidden from company counts and skipped during scans.`))return;t.disabled=!0,Rr(t.dataset.deleteCompany).catch(()=>{S.textContent=`could not deactivate company.`,t.disabled=!1});return}let n=e.target.closest(`[data-delete-career-page]`);if(!n)return;let r=n.closest(`.company-link-row`)?.querySelector(`.company-link-text`)?.textContent?.trim();window.confirm(`Delete ${r||`this career link`}?`)&&(n.disabled=!0,Lr(n.dataset.deleteCareerPage).catch(()=>{S.textContent=`could not delete link.`,n.disabled=!1}))}),Je.addEventListener(`change`,e=>{let t=e.target.closest(`input[type="checkbox"], select, input[data-setting-text], textarea[data-setting-textarea]`);t&&vr(t)}),Je.addEventListener(`submit`,async e=>{e.preventDefault();let t=Je.querySelector(`button[type="submit"]`),n=Je.querySelectorAll(`input[type="checkbox"][name], select[name], input[data-setting-text][name], textarea[data-setting-textarea][name]`),r={};n.forEach(e=>{let t=e.name;t&&(r[t]=e.type===`checkbox`?e.checked:e.value)}),t.disabled=!0,t.textContent=`saving...`;try{x.textContent=`saving settings...`;let e=await fetch(`/api/config`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(r)});if(!e.ok)throw Error(`Config update failed`);K(await e.json(),`settings saved.`)}catch{x.textContent=`could not save settings.`,x.classList.remove(`is-empty`)}finally{t.disabled=!1,t.textContent=`save settings`}}),et.addEventListener(`input`,()=>{rt.disabled=!et.value.trim()}),nt.addEventListener(`click`,br),rt.addEventListener(`click`,xr),at.addEventListener(`click`,yr),yt.addEventListener(`click`,wr);function Fa(){if(window.location.hash===`#prepped-roles`){la();return}ua({clearHash:!1})}window.addEventListener(`popstate`,Fa),Cr(),window.location.hash===`#prepped-roles`&&Fa(),Zr({applyDefaultCollapsed:!0}).catch(()=>{_n(null,`could not load resume.`),yn([],`could not load cover letter examples.`),wn()}),qr().then(()=>{Jr()}).catch(()=>{Fe.textContent=`could not load scan status`});