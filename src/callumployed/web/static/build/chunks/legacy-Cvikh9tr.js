import{t as e}from"./preload-helper-Czpn1I53.js";var{sankey:t,sankeyLinkHorizontal:n}=await e(async()=>{let{sankey:e,sankeyLinkHorizontal:t}=await import(`/assets/d3-sankey.js`);return{sankey:e,sankeyLinkHorizontal:t}},[]),r=document.querySelector(`#stats`),i=document.querySelector(`#status-list`),a=document.querySelector(`#search-toggle`),o=document.querySelector(`#search-dialog`),s=document.querySelector(`#search-backdrop`),c=document.querySelector(`#search-form`),l=document.querySelector(`#search-input`),u=document.querySelector(`#close-search`),d=document.querySelector(`#materials-panel`),ee=document.querySelector(`#materials-toggle`),f=document.querySelector(`#materials-body`),te=document.querySelector(`#materials-summary`),p=document.querySelector(`#materials-required-warning`),m=document.querySelector(`#resume-meta`),h=document.querySelector(`#resume-upload`),ne=document.querySelector(`#resume-upload-button`),re=document.querySelector(`#resume-resource-meta`),ie=document.querySelector(`#resume-resource-upload`),ae=document.querySelector(`#resume-resource-upload-button`),oe=document.querySelector(`#resume-resource-list`),se=document.querySelector(`#cover-letter-meta`),ce=document.querySelector(`#cover-letter-upload`),le=document.querySelector(`#cover-letter-upload-button`),ue=document.querySelector(`#cover-letter-list`),de=document.querySelector(`#experience-note-meta`),fe=document.querySelector(`#experience-note-upload`),pe=document.querySelector(`#experience-note-upload-button`),me=document.querySelector(`#experience-note-list`);document.querySelector(`#material-index-button`);var he=document.querySelector(`#material-index-warning`),ge=document.querySelector(`#material-index-status`),_e=document.querySelector(`#review-discovered`),ve=document.querySelector(`#prep-interested`),g=document.querySelector(`#review-view`),ye=document.querySelector(`#review-heading`),be=document.querySelector(`#review-progress`),xe=document.querySelector(`#review-card`),Se=document.querySelector(`#close-review`),_=document.querySelector(`#prep-view`),Ce=document.querySelector(`#prep-heading`),we=document.querySelector(`#prep-progress`),v=document.querySelector(`#prep-card`),Te=document.querySelector(`#close-prep`),Ee=document.querySelector(`#prepped-roles`),De=document.querySelector(`#prepped-view`),Oe=document.querySelector(`#close-prepped`),ke=document.querySelector(`#prepped-summary`),Ae=document.querySelector(`#regenerate-all-cover-letters`),je=document.querySelector(`#prepped-bulk-status`),Me=document.querySelector(`#prepped-list`),Ne=document.querySelector(`#prepped-detail`),y=document.querySelector(`#scan-all-button`),Pe=document.querySelector(`#manage-companies-button`),b=document.querySelector(`#scan-status-bar`),Fe=document.querySelector(`#scan-status-text`),Ie=document.querySelector(`#scan-last-time`),Le=document.querySelector(`#scan-failures-open`),Re=document.querySelector(`#scan-failures-dialog`),ze=document.querySelector(`#scan-failures-backdrop`),Be=document.querySelector(`#scan-failures-close`),Ve=document.querySelector(`#scan-failures-list`),He=document.querySelector(`#toggle-all`),Ue=document.querySelector(`#collapse-empty`),We=document.querySelector(`#toolbar-summary`),Ge=document.querySelector(`#settings-open`),Ke=document.querySelector(`#settings-view`),qe=document.querySelector(`#settings-close`),x=document.querySelector(`#settings-status`),Je=document.querySelector(`#settings-form`),Ye=document.querySelector(`#settings-profile-options`),Xe=document.querySelector(`#settings-autoprep-options`),Ze=document.querySelector(`#settings-options`),Qe=document.querySelector(`#central-store-summary`),$e=document.querySelector(`#central-store-sync-summary`),et=document.querySelector(`#central-api-url-input`),tt=document.querySelector(`#central-passkey-input`),nt=document.querySelector(`#central-save-button`),rt=document.querySelector(`#central-sync-button`),it=document.querySelector(`#recommendation-history-summary`),at=document.querySelector(`#clear-recommendation-history`),ot=document.querySelector(`#metrics-open-button`),st=document.querySelector(`#metrics-view`),ct=document.querySelector(`#metrics-close`),lt=document.querySelector(`#metrics-status`),ut=document.querySelector(`#metrics-overview`),dt=document.querySelector(`#metrics-sections`),ft=document.querySelector(`#metrics-scan-list`),pt=document.querySelector(`#sankey-open-button`),mt=document.querySelector(`#sankey-view`),ht=document.querySelector(`#sankey-close`),gt=document.querySelector(`#sankey-status`),_t=document.querySelector(`#sankey-canvas`),vt=document.querySelector(`#sankey-path-list`),yt=document.querySelector(`#app-update-button`),bt=document.querySelector(`#companies-view`),xt=document.querySelector(`#companies-close`),S=document.querySelector(`#companies-status`),St=document.querySelector(`#company-create-form`),C=document.querySelector(`#companies-list`),Ct=document.querySelector(`#role-add-form`),wt=document.querySelector(`#role-url-input`),Tt=document.querySelector(`#role-company-input`),Et=document.querySelector(`#role-company-options`),Dt=document.querySelector(`#role-add-status`),Ot=3,kt=1200,At=new Set([`applied`,`OA`,`interview`,`rejected`,`offer`]),jt=new Map([[`discovered`,`#4f6472`],[`interested`,`#00897b`],[`disinterested`,`#626970`],[`applied`,`#2257ad`],[`oa`,`#b36b00`],[`interview`,`#5f2bd8`],[`rejected`,`#b93d2d`],[`offer`,`#137347`],[`closed`,`#53606b`],[`archived`,`#765b4a`]]),Mt=/^(?:about (?:the )?(?:role|team|job)|about this role|job description|job responsibilities|minimum qualifications|preferred qualifications|qualifications|requirements|responsibilities|what to expect|what (?:you'll|you’ll|you will) (?:bring|do)|what'?s in it for you|who you are|your objectives|your skills & talents):?$/i,Nt=!0,w=null,Pt=null,T=[],E=[],D=[],Ft=null,O=[],k=[],A=new Map,It=new Map,j=new Map,Lt=new Map,M=new Map,Rt=new Map,zt=new Map,Bt=new Map,N=[],P=null,Vt=null,Ht=!1,Ut=``,F=null,Wt=new Set,Gt=new Map,I=new Set,L=new Map,Kt=new Map,qt=new Map,Jt=new Set,Yt=!1,Xt=0,Zt=null,Qt=!1,$t=null,en=null,tn=null,nn=null,R=null,rn=[],an=new Map;function z(){return w?.query?.trim()??``}function on(){let e=!!z();a.classList.toggle(`search-active`,e),a.setAttribute(`aria-label`,e?`clear search`:`search jobs`)}function sn(){l.value=z(),o.hidden=!1,c.hidden=!1,l.focus(),l.select()}function cn(){o.hidden=!0,c.hidden=!0,a.focus()}function ln(e){return e?new Intl.DateTimeFormat(void 0,{month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`}).format(new Date(e)).toLocaleLowerCase():``}function B(e){return e?new Intl.DateTimeFormat(void 0,{month:`short`,day:`numeric`,hour:`numeric`,minute:`2-digit`}).format(new Date(e)).replace(`, `,` `).toLocaleLowerCase():``}function V(e){return String(e??``).replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`).replaceAll(`'`,`&#039;`)}function H(e){return String(e??``).toLocaleLowerCase()}function U(e){return V(H(e))}function un(e){try{let t=new URL(String(e||``));return[`http:`,`https:`].includes(t.protocol)?t.href:``}catch{return``}}function dn(e){return e}function W(e=v){e.querySelectorAll(`[data-prep-resume-latex], [data-prep-cover-letter-latex]`).forEach(dn)}function fn(){return`
  ...
  `}function hn(e,t,n){let r=`<span class="role-title-text">${U(e)}</span>`;return t?`<a class="${n}" href="${V(t)}" target="_blank" rel="noreferrer">${r}${fn()}</a>`:`<span class="${n}">${r}</span>`}function gn(e){r.innerHTML=[[`companies`,e.companies_total],[`jobs`,e.jobs_total],[`applications`,e.applications_total]].map(([e,t])=>`<dl class="stat"><dt>${U(e)}</dt><dd>${t}</dd></dl>`).join(``)}function _n(e=w){if(!e){We.innerHTML=``;return}let t=t=>e.statuses.find(e=>e.key===t)?.count??0;We.innerHTML=[[`discovered`,t(`discovered`)],[`interested`,t(`interested`)],[`applied`,e.stats?.applications_total??0],[`total`,e.stats?.jobs_total??0]].map(([e,t])=>`
        <dl>
          <dt>${U(e)}</dt>
          <dd>${t}</dd>
        </dl>
      `).join(``)}function vn(e,t=``){if(Pt=e,ne.textContent=e?`replace`:`upload`,t){m.textContent=t;return}if(!e){m.textContent=`no resume uploaded`;return}let n=B(e.updated_at),r=Dn(e.content_bytes);m.textContent=[H(e.filename),r,n].filter(Boolean).join(` | `)}function yn(e,t,n,{binary:r=!1}={}){let i=r?e.filename:e.id;return`
  ...
  `}function Un(e){w=e,l.value=e.query,on(),gn(e.stats),_n(e),jn(e.statuses),ja(),pi(e.statuses),hi(e.statuses)}function Wn(e){$t=e??null;let t=!!e?.scanning,n=t&&!!e?.cancel_requested,r=Number(e?.completed_companies??0),i=Number(e?.total_companies??0),a=Number(e?.failed_companies??0),o=typeof e?.error==`string`?e.error.trim():``,s=Array.isArray(e?.failures)?e.failures:[];y.disabled=n,y.textContent=t?n?`cancelling...`:`cancel scan`:`scan roles`,y.classList.toggle(`danger`,t&&!n),b.hidden=!t&&!o&&s.length===0,b.classList.toggle(`scanning`,t),b.classList.toggle(`scan-error`,!t&&!!o||s.length>0),Fe.textContent=n?`cancelling scan...`:t?`scanning roles${i>0?` ${r}/${i}`:``}${a>0?`, ${a} failed`:``}`:s.length>0?`${s.length} recent scan ${s.length===1?`failure`:`failures`}`:o?`last scan error: ${o}`:`scan idle`,Le&&Ve&&(Le.hidden=s.length===0,Ve.innerHTML=s.slice(0,5).map(e=>{let t=e?.company_name||`unknown company`,n=e?.error||`scan failed`;return`
          <p>
            <span>${U(t)}</span>
            <span>${V(n)}</span>
          </p>
        `}).join(``),s.length===0&&Kn());let c=e?.last_scan_at;Ie.textContent=c?`last scan: ${B(c)}`:`last scan: never`,Qt&&!t&&q(z()).catch(()=>{}),Qt=t}function Gn(){Le.hidden||(Re.hidden=!1,Be.focus())}function Kn(){Re.hidden=!0}function G(e,t=``){en=e;let n=Array.isArray(e?.settings)?e.settings:[],r=n.filter(e=>e.key?.startsWith(`applicant_`)),i=n.filter(e=>e.key?.startsWith(`autoprep_`)),a=n.filter(e=>!e.key?.startsWith(`applicant_`)&&!e.key?.startsWith(`autoprep_`)),o=e?.central??{};x.textContent=t,x.classList.toggle(`is-empty`,!t);let s=Number(e?.recommendation_history_count??0);it.textContent=s>0?`${s} saved ${s===1?`feedback decision`:`feedback decisions`}`:`no saved resume feedback decisions`,at.disabled=s===0,qn(o),Ye.innerHTML=r.map(e=>Jn(e)).join(``),Xe.innerHTML=i.map(e=>Jn(e)).join(``),Ze.innerHTML=a.map(e=>Jn(e)).join(``),K(!1)}function qn(e){let t=e?.api_url??``;et.value=t,tt.value=``;let n=e?.passkey_configured?`passkey saved`:`no passkey saved`;Qe.textContent=t?`${H(t)} | ${n}`:`no api url | ${n}`,$e.textContent=`${Number(e?.companies_linked??0)} linked | ${Number(e?.companies_unlinked??0)} unlinked | ${Number(e?.companies_needs_review??0)} review | ${Number(e?.companies_failed??0)} failed`,rt.disabled=!t}function Jn(e){if(e.control===`textarea`&&e.editable!==!1)return Xn(e);if(e.control===`text`&&e.editable!==!1)return Yn(e);if(e.control===`select`&&e.editable!==!1)return Zn(e);if(e.control!==`toggle`||e.editable===!1)return Qn(e);let t=e.value?`checked`:``,n=e.default?`on by default`:`off by default`;return`
  ...
  `}function K(e){Je.querySelectorAll(`input, select, textarea`).forEach(t=>{t.disabled=e}),nt.disabled=e,rt.disabled=e||!et.value.trim(),yt.disabled=e}async function $n(){Ke.hidden=!1,document.body.classList.add(`settings-open`),qe.focus(),en?G(en):(x.textContent=`loading settings...`,x.classList.remove(`is-empty`),Ze.innerHTML=``);try{await tr()}catch{x.textContent=`could not load settings.`}}function er(){Ke.hidden=!0,document.body.classList.remove(`settings-open`),Ge.focus()}async function tr(){let e=await fetch(`/api/config`);if(!e.ok)throw Error(`Config request failed`);G(await e.json())}function nr(e){let t=e?.value;return t==null?`n/a`:e?.kind===`ratio`?Number(t).toLocaleString(void 0,{maximumFractionDigits:2,minimumFractionDigits:0}):typeof t==`number`?t.toLocaleString():H(t)}function rr(e,t=`metric-card`){return`
    <article class="${t}">
      <span>${U(e?.label)}</span>
      <strong>${V(nr(e))}</strong>
    </article>
  `}function ir(e,t=``){tn=e,lt.textContent=t||(e?.updated_at?`updated ${B(e.updated_at)}`:``),lt.classList.toggle(`is-empty`,!lt.textContent);let n=Array.isArray(e?.overview)?e.overview:[],r=Array.isArray(e?.sections)?e.sections:[],i=Array.isArray(e?.recent_scans)?e.recent_scans:[];ut.innerHTML=n.map(e=>rr(e)).join(``),dt.innerHTML=r.map(ar).join(``),ft.innerHTML=i.length?i.map(or).join(``):`<p class="empty-copy">no scan runs recorded.</p>`}function ar(e){let t=Array.isArray(e?.metrics)?e.metrics:[];return`
  ...
  `}async function sr(){st.hidden=!1,document.body.classList.add(`metrics-open`),ct.focus(),tn?ir(tn):(lt.textContent=`loading metrics...`,lt.classList.remove(`is-empty`),ut.innerHTML=``,dt.innerHTML=``,ft.innerHTML=``);try{await lr()}catch{lt.textContent=`could not load metrics.`}}function cr(){st.hidden=!0,document.body.classList.remove(`metrics-open`),ot.focus()}async function lr(){let e=await fetch(`/api/metrics`);if(!e.ok)throw Error(`Metrics request failed`);ir(await e.json())}function ur(e,t=``){nn=e;let n=Number(e?.role_count??0),r=Array.isArray(e?.links)?e.links:[],i=Array.isArray(e?.paths)?e.paths:[];gt.textContent=t||(e?.updated_at?`${n.toLocaleString()} roles | updated ${B(e.updated_at)}`:``),gt.classList.toggle(`is-empty`,!gt.textContent),_t.innerHTML=r.length?dr(e):`<p class="empty-copy">no role transitions recorded yet.</p>`,vt.innerHTML=i.length?i.map(hr).join(``):`<p class="empty-copy">no role paths recorded yet.</p>`}function dr(e){let t=Array.isArray(e?.nodes)?e.nodes:[],n=Array.isArray(e?.links)?e.links:[],r=mr(t,n),i=r.nodes,a=r.links,o=(r.flowLinks??n).map(e=>{let t=i.get(e.source),n=i.get(e.target),r=a.get(e);if(!t||!n||!r)return``;let o=r.width,s=n.x<t.x,c=fr(e.target),l=r.priority?`0.42`:s?`0.28`:`0.34`,u=r.path??pr({isBacktrack:s,sourceX:t.x+t.width,sourceY:r.sourceY,targetX:n.x,targetY:r.targetY,width:o});return`
  ...
  `}function Si(e){let t=Number(e.review_later_count??0);return t<=Ot?``:`role review has been postponed ${t} times. it is recommended to set it to disinterested.`}function J(e,t,n=!1,r=``){if(!t)return``;let i=n?`<a href="${V(t)}" target="_blank" rel="noreferrer">${U(t)}</a>`:U(t);return`
  ...
  `}function Y(e,t={}){let n=A.get(e.id);if(!t.loading&&!t.error&&!t.analysis&&n)return Y(e,{analysis:n});if(!t.loading&&!t.error&&!t.analysis)return`
...
`,`<br>`)}</div></details>`:``}
    ...
    <div class="prepped-detail-actions">
      ...
      <button class="prepped-disinterested" type="button" data-autoprep-disinterested aria-busy="${o?`true`:`false`}" ${o?`disabled`:``}>${o?`Moving to Disinterested...`:`Move to Disinterested`}</button>
