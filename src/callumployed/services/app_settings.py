...
APPLICANT_PROFILE_REPREP_DUE_CONFIG_KEY = "applicant_profile_reprep_due_at"
APPLICANT_PROFILE_REPREP_DELAY_SECONDS = 30.0
BOOL_KEYS = (
...
def set_setting(connection: sqlite3.Connection, key: str, value: object) -> str | bool:
    ...
    applicant_profile_changed = (
        key in APPLICANT_KEYS and (get_config_value(connection, key) or "") != cleaned
    )
