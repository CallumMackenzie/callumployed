...
def test_application_questions_styles_and_cache_keys_are_versioned() -> None:
    ...
    assert '<link rel="stylesheet" href="/assets/app.css?v=vanilla-20260903-10" />' in index
    assert '<script type="module" src="/assets/app.js?v=vanilla-20260903-10"></script>' in index
