...
def test_application_answer_regeneration_supports_per_answer_tweak_drafts() -> None:
    ...
    assert '<link rel="stylesheet" href="/assets/app.css?v=vanilla-20260914-26" />' in index
    assert '<script type="module" src="/assets/app.js?v=vanilla-20260914-26"></script>' in index
